...
\begin{figure}
\Large{PLACEHOLDER FOR FIGURE; see
\url{https://github.com/tskit-dev/tskit-paper/issues/32}}
\caption{The tskit data model and software ecosystem. [Further
...
in a simple tabular form\cite{kelleher2018efficient} (Figure 1).
