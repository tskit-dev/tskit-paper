...
\begin{longtable}{l c r p{3cm} p{4cm}}
\caption{Example longtable with five columns}\label{tab:example} \\
\hline
...
A & 1 & 3.14 & Some text & More descriptive text \\
B & 2 & 2.71 & Some text & More descriptive text \\
C & 3 & 1.62 & Some text & More descriptive text \\
D & 4 & 0.57 & Some text & More descriptive text \\
E & 5 & 1.41 & Some text & More descriptive text \\
F & 6 & 2.23 & Some text & More descriptive text \\
G & 7 & 0.99 & Some text & More descriptive text \\
H & 8 & 1.73 & Some text & More descriptive text \\
...
We performed a search for published software tools that use tskit.
[TODO document details and exact inclusion criteria]

Named software tools 
...
\newcommand{\sectionrow}[1]{\multicolumn{5}{c}{#1}\\\hline}

\begin{longtable}{lllrr}
\caption{The tskit software ecosystem. See supplementary text 
for details on the columns and inclusion criteria. Entries marked with
...
% \multicolumn{1}{c}{\textbf{interface}} & 
...
\sectionrow{Simulation}
\input{rows/simulation.tex}
% \sectionrow{ARG}
\input{rows/arg_inference.tex}
\input{rows/analysis.tex}
\input{rows/popgen_inf.tex}
\input{rows/statgen_inf.tex}
\input{rows/visualisation.tex}
