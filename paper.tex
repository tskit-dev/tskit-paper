...
enabled a broad ecosystem of downstream software (Table S1) and has established
...
For each tool listed in Table S1, we list: its name (with a clickable
hyperlink to its source code repository); the primary implementation
language(s) of the tool; the DOI (with clickable hyperlink) 
of the publication in which this 
