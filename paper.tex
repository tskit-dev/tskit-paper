...
This paper marks the release of tskit 1.0, 
a milestone that was chosen to formalise long-term stability
...
This encoding provides a lossless representation of a general class of ARGs
...
<<<<<<< Updated upstream
The same representation later yielded substantial speedups in
forward-time simulation by avoiding explicit simulation of neutral mutations\cite{kelleher2018efficient}.
=======
The same representation was later used for
forward-time simulation of ARGs, yielding substantial speedups by avoiding
explicit simulation of neutral mutations\cite{kelleher2018efficient}.
>>>>>>> Stashed changes
Because these forward-time and coalescent
simulators share this rich data structure,
their complementary strengths can be combined within a single workflow.
...
Downstream tools thus inherit performance and correctness properties from a shared,
well-tested core.
...
inference, analysis, and visualisation---with 63 published tools now using tskit
as a core dependency (Table S1).
Tskit thus builds on the theoretical potential provided by
the succinct tree sequence data structure~\cite{kelleher2016efficient}
and its formalisation as a general ARG representation~\cite{wong2024general},
providing a mature, general purpose software library
for scalable ARG analysis (see Supplementary Information).
By focusing on stable
primitives rather than prescribing analytical pipelines, tskit allows
...
In this way, tskit 1.0 provides
