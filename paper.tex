...
ARG picture &
Tables encoding &
C, Python, R, Rust logos &
\begin{tabular}{ll}
\textbf{Simulation} & \textbf{Inference} \\
msprime & tsinfer \\
SLiM & tsdate \\
fwdpy11 &  \\
stdpopsim &  sc2ts \\
...
slendr &  \\
gridCoal &  \\
\textbf{Analysis} & \textbf{Visualisation} \\
TWISSTNTERN & tsbrowse \\
TWISSTNTERN & ARGScape \\
\end{tabular}
\end{tabular}
\caption{Tskit provides a lossless and 
general encoding of Ancestral Recombination Graphs through
a simple tabular data model. Multiple efficient language
bindings to the core C library have enabled a thriving 
ecosystem of downstream tools.}
\end{figure}
