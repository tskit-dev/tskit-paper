...
We are grateful for the editor’s constructive assessments
...
the paper ``marks the release of tskit 1.0,'' which ``formalises long-term
...
Supplementary Information).'' The new supplementary section then provides the
...
iteration, simplify, and later core operations for statistics, ancestry, and
relatedness. The section also points to published benchmarks demonstrating
...
Although we have made some shortening edits to compensate for the
new material, the revised main text is now slightly over the word limit.
Given the positive overall assessment,
we were unsure where additional cuts could be made
