...
For each tool in Supplementary Table 1, we list: its name (with a clickable
...
(\url{https://openalex.org}) retrieved on 2026-04-27.
...
More broadly, Supplementary Table 1 shows that tskit now underpins a substantial
...
Supplementary Table 2 lists properties and operations that tskit supports, grouped
